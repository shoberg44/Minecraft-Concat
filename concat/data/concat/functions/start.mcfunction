...
execute if score $inputMode concat matches 7..8 run scoreboard players operation $stringtotal concat += $substring concat
...
execute if score $inputMode concat matches 5 run scoreboard players add $substring concat 1
...
execute if score $inputMode concat matches 7.. run scoreboard players add $substring concat 1
execute if score $inputMode concat matches 7.. run scoreboard players operation $stringtotal concat += $substring concat
#-----------------------
#8 6 score
#sets parameter
...
execute if score $inputMode concat matches 10 run scoreboard players add $substring concat 1
execute if score $inputMode concat matches 9.. run scoreboard players operation $stringtotal concat += $substring concat
#-----------------------
#gets length
